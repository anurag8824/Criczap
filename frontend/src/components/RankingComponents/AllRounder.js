...
const AllRounder = ({mdata}) => {
  ...
  return (
    <div className='w-full '>
      ...
      <p className='border-b pb-2 font-medium text-xl'> Men's All-Rounder Ranking
      </p>

      <div className='md:flex gap-2'>

        <div className='border rounded-md md:w-1/3  mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>Test All-Rounder Ranking</p>
          ...
          <div className="relative overflow-x-auto scrollbar-hide">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {(showFullTable ? mdata?.["all-rounders"]?.tests : mdata?.["all-rounders"]?.tests?.slice(0, 5))?.map((item, index) =>
                  item ? (
                    <tr
                      key={index}
        ...
        <div className='border rounded-md md:w-1/3 mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>ODI All-Rounder Ranking</p>
          ...
          <div className="relative overflow-x-auto scrollbar-hide">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {(showFullTable2 ? mdata?.["all-rounders"]?.odis : mdata?.["all-rounders"]?.odis?.slice(0, 5))?.map((item, index) =>
                  item ? (
                    <tr
                      key={index}
                      className={`border-b ${item.rank === "1" ? "bg-blue-950 text-white" : "bg-white"} dark:bg-gray-800 dark:border-gray-700`}
        ...
        <div className='border rounded-md md:w-1/3 mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>T20 All-Rounder Ranking</p>
          ...
          <div className="relative overflow-x-auto scrollbar-hide">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {(showFullTable3 ? mdata?.["all-rounders"]?.t20s : mdata?.["all-rounders"]?.t20s?.slice(0, 5))?.map((item, index) =>
                  item ? (
                    <tr
                      key={index}
                      className={`border-b ${item.rank === "1" ? "bg-blue-950 text-white" : "bg-white"} dark:bg-gray-800 dark:border-gray-700`}
