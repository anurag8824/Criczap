...
const Batters = ({mdata}) => {
  ...
  return (
    <div className='w-full '>
      ...
      <p className='border-b pb-2 font-medium text-xl'> Men's batting Ranking
      </p>

      <div className='md:flex gap-2'>

        <div className='border rounded-md md:w-1/3  mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>Test batting Ranking</p>
          ...
          <div className="relative overflow-x-auto scrollbar-hide">
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {(showFullTable ? mdata?.batsmen?.tests : mdata?.batsmen?.tests?.slice(0, 5))?.map((item, index) =>
                  item ? (
                    <tr
                      key={index}
        ...
        <div className='border rounded-md md:w-1/3 mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>ODI Batting Ranking</p>
        ...
        <div className='border rounded-md md:w-1/3 mt-4'>
          <p className='px-2 py-2 font-medium text-lg text-blue-950 dark:text-white'>T20 batsmen Ranking</p>
